...
<body style="background-color: #e8f5ff;">
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarText">
			...
			<li class="nav-item active"><a class="nav-link" href="#">
						<form id="searchResult"><input type="text"><button>Search</button></form>
				</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="details.jsp"><span
						class="fa fa-user-circle"></span><%=" Hi," + user.getFirstname() + " " + user.getLastname()%><span class="sr-only">(current)</span></a>
	...
	<div class="container" style="margin-top: 10px;">
		<form id="add-post-form" class="form-control" action="PostServlet" method="POST">
			<div class="form-group shadow-textarea" id="div_post">
				<textarea id="post_textarea"
					class="form-control z-depth-1 border border-dark" rows="8"
					cols="240" placeholder="What's in your mind" name="postcontent"></textarea>
				<button type="submit" id="post_button" class="btn btn-dark">Post</button>
			</div>
		</form>
	</div>
	 -->
        ...
        <div class="card" style="margin-top: 1rem;">
            <div class="row">
                ...
                <form id="add-post-form" action="PostServlet" method="POST" >
						<textarea id="post_textarea"
							class="form-control z-depth-1 border border-dark"
							style="width: 100%; height: 200px;"
							placeholder="What's in your mind" name="postcontent" required></textarea></div>
                
                 <button type="button" class="btn btn-dark" style="margin:5%;" onclick="record()">REC</button>
                 <button type="submit" id="post_button" class="btn btn-dark" style="margin:1%;">Post</button>
